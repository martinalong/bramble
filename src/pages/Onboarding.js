...
class ProviderOnboarding extends Component {
    constructor(props) {
        super(props);
            ...
            <div className="page">
                ...
                <div className="login-steps">
                    <div className="login-step">
                        ...
                        <p className="login-step-text">Account type</p>
                    </div>
                    <div className="login-step">
                ...
                <div>
                    ...
                    <div className="login-step">
                        {this.state.steps[2] ? <FiCheck className="login-step-number login-step-check"/> : <h2 className="login-step-number">3</h2>}
                        <p className="login-step-text">Practice info</p>
                    </div>
                </div>
                }
                <form id="signup-form" className="login-form signup-form"> 
                    ...
                    <div className={this.state.currStep === 2 ? "part-two" : "part-two hide"}>
                        ...
                        <input id="lastName" className="login-input required2" type="text" name="lastName" placeholder="Last name*" onBlur={this.handleCheck} required/>
                        <div id="specialty">
                            <select id="specialtyVal" className="login-dropdown required2" name="specialty" onBlur={this.handleCheck} onChange={this.handleCheck} defaultValue={"DEFAULT"} required>
                            ...
                            <div className="line" id="line-specialty"/>
                        </div>
                        <div id="gender">
                            <select id="sex" className="login-dropdown required2" name="sex" onBlur={this.handleCheck} onChange={this.handleCheck} defaultValue={"DEFAULT"} required>
                                <option value="DEFAULT" className="login-hide" disabled>Gender*</option>
                        ...
                        <div className="two-col">
                            <input id="phoneNumber" className="login-input required2" type="text" name="phoneNumber" placeholder="Work phone number*" maxLength="10" onBlur={this.handleCheck} required/>
                            <input id="phoneNumber" className="login-input" type="text" name="phoneNumber" placeholder="Extension" maxLength="10"/>
                        </div>
                    </div>}
                    {this.state.isPatient ? 
                    ...
                    <div className={this.state.currStep === 3 ? "part-three" : "part-three hide"}>
                        ...
                        <input id="practiceName" className="login-input required3" type="text" name="practiceName" placeholder="Practice Name" onBlur={this.handleCheck} required/>
                        <input id="practicePhoneNumber" className="login-input required3" type="text" name="practicePhoneNumber" placeholder="Phone number*" maxLength="10" onBlur={this.handleCheck} required/>
                            <input id="address" className="login-input required3" type="text" name="address" placeholder="Address*" onBlur={this.handleCheck} required/>
                            <input className="login-input" type="text" name="address2" placeholder="Address line 2 (optional)"/>
                            <input id="city" className="login-input required2" type="text" name="city" placeholder="City*" onBlur={this.handleCheck} required/>
                            <div className="two-col"> 
                                <div id="state">
